    ...
    <div className="bg-slate-50 min-h-screen py-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center max-w-xl mx-auto mb-16 flex flex-col items-center gap-3">
          ...
          <p className="text-xs sm:text-sm text-slate-500 max-w-sm leading-relaxed mt-2">
            Verified proof of official authorization to sell and distribute leading battery and solar brands.
          </p>
        </div>

        {/* Certificates Grid — real images, minimal caption, no replica mockups */}
        ...
        {/* Lightbox — sized to the image itself, no forced aspect ratio */}
          ...
          >
            ...
            {activeCert && (
              <div className="relative">
                {/* Custom close button — anchored to the actual visible card,
