import { Award, Compass, Heart, ShieldAlert, BadgeCheck, Phone, Mail } from 'lucide-react'
...
export default function AboutPage() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
            ...
            {pillars.map((pillar, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-heading font-bold text-lg text-white">{pillar.title}</h3>
      ...
      {/* CTA section */}
      <section className="py-16 px-4 text-center max-w-xl mx-auto flex flex-col items-center gap-6">
        ...
        <div className="flex gap-4">
          <Link
            ...
            className={cn(
              ...
              'bg-accent-orange hover:bg-accent-orange/95 text-white font-extrabold'
            )}
          >
            Get a Quote
          </Link>
