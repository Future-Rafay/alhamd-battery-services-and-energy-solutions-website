...
export function Header({ settings, categories }: HeaderProps) {
  ...
  return (
    <header className="w-full z-40 ">
      ...
      {/* ── Top info bar (md+) ── */}
      <div className="hidden md:block brand-blue-gradient  text-white text-xs border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-4 h-9 flex items-center justify-between gap-6">
      ...
      <div
        className={cn(
          'w-full transition-all py-2 px-4 duration-300',
          isScrolled
