  ...
  return (
    <footer className="bg-white text-slate-600">
      ...
      <div className="bg-primary px-4">
        <div className="max-w-7xl mx-auto py-5 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 ">
      ...
      {/* ── Main grid ── */}
      <div className='px-4'>
        <div className="max-w-7xl mx-auto py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
